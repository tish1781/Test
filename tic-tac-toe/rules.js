...
function begin_play(){
	...
	else if(isEmpty(player1.value) || isEmpty(player2.value)){
		alert("Both player field must not be empty.");
		return;
	}
	else{
...
function reset_play(){
	...
	var index;
	for(index = 0; index < table_ids.length; index++){
		var temp = table_ids[index];
